...
const DonationForm = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Picker selectedValue={ageGroup} style={styles.input} onValueChange={(itemValue, itemIndex) => setAgeGroup(itemValue)}>
      ...
      <Picker selectedValue={paymentMode} style={styles.input} onValueChange={(itemValue, itemIndex) => setPaymentMode(itemValue)}>
      ...
      <Picker selectedValue={occupation} style={styles.input} onValueChange={(itemValue, itemIndex) => setOccupation(itemValue)}>
