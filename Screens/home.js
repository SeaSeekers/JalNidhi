...
const YourComponent = () => {
  ...
  const emergencyNumbers = [
    { label: 'Emergency 1', value: 'emergency1' },
    { label: 'Emergency 2', value: 'emergency2' },
    { label: 'Emergency 3', value: 'emergency3' },
  ];
      ...
      <View style={styles.locationContainer}>
        <View style={styles.locationContent}>
          <View style={styles.locationTextContainer}>
            <Text style={styles.locationHeadingText}>Your Current Location</Text>
